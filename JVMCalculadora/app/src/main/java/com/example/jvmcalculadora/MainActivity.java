...
public class MainActivity<X, Y, Resultado> extends AppCompatActivity implements View.OnClickListener {
    private EditText n1;
    private EditText n2;
...
public void Sumar(View view){
    ...
    String resultadoo=String.valueOf(suma);
    resultado.setText(resultadoo);
